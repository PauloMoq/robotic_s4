...
AUTEUR : [Paul HURDEBOURCQ]
FORMATION : [Master 2 Data&IA (Alternance)]
ANNEE : 2024-2026
...
Fleches HAUT / BAS : Avancer et reculer.

Fleches GAUCHE / DROITE : Tourner sur place.

Pour le Moteur Omnidirectionnel :

Fleches : Se déplacer dans toutes les directions (X et Y).
...
LE MODELE (Dossier robot/model) : C'est le cerveau et la physique. Il calcule la position du robot, gère les collisions avec les obstacles rouges et fait revenir le robot de l'autre côté de l'écran s'il sort (wrap-around).

LA VUE (Dossier robot/vue) : C'est ce qu'on voit à l'écran. Elle dessine la grille, les obstacles et le robot en transformant les mètres en pixels.

LE CONTROLEUR (Dossier robot/controler) : C'est le lien avec le clavier. Il lit les touches pressées et donne les ordres de vitesse au robot.
